...
const CourseCard = ({ cardData, currentCard, setCurrentCard }) => {
   return (
      <div
         className={`max-w-[300px] w-[360px] lg:w-[30%] ${currentCard === cardData?.heading
      ...
      >
         <div className="border-b-[2px] border-richblack-400 border-dashed h-[80%] p-6 flex flex-col gap-3">
            ...
            <div
               className={`text-richblack-400  transition-all ease-linear ${currentCard === cardData?.heading
                     ? "hover:text-black"
                     : "hover:text-white"
                  }`}
            >
         ...
         <div
            className={`flex justify-between  transition-all ease-linear ${currentCard === cardData?.heading
